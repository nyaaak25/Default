;------------------------------------------------------------------------------------------------------------------------
function ret_pressure, TA, TB, SZA, EA, PA, Dust, Waterice, Albedo, wave, Intensity
;------------------------------------------------------------------------------------------------------------------------
...
if wave eq 0 then LMS0 = (y - Intensity)^2
if wave eq 1 then LMS1 = (y - Intensity)^2
if wave eq 2 then LMS2 = (y - Intensity)^2
if wave eq 3 then LMS3 = (y - Intensity)^2
if wave eq 4 then LMS4 = (y - Intensity)^2
if wave eq 5 then LMS5 = (y - Intensity)^2
if wave eq 6 then LMS6 = (y - Intensity)^2
if wave eq 7 then LMS7 = (y - Intensity)^2
if wave eq 8 then LMS8 = (y - Intensity)^2
if wave eq 9 then LMS9 = (y - Intensity)^2
if wave eq 10 then LMS10 = (y - Intensity)^2
if wave eq 11 then LMS11 = (y - Intensity)^2
if wave eq 12 then LMS12 = (y - Intensity)^2
if wave eq 13 then LMS13 = (y - Intensity)^2
if wave eq 14 then LMS14 = (y - Intensity)^2
if wave eq 15 then LMS15 = (y - Intensity)^2
if wave eq 16 then LMS16 = (y - Intensity)^2
if wave eq 17 then LMS17 = (y - Intensity)^2
if wave eq 18 then LMS18 = (y - Intensity)^2
if wave eq 19 then LMS19 = (y - Intensity)^2
if wave eq 20 then LMS20 = (y - Intensity)^2
if wave eq 21 then LMS21 = (y - Intensity)^2
if wave eq 22 then LMS22 = (y - Intensity)^2
if wave eq 23 then LMS23 = (y - Intensity)^2
if wave eq 24 then LMS24 = (y - Intensity)^2
if wave eq 25 then LMS25 = (y - Intensity)^2
if wave eq 26 then LMS26 = (y - Intensity)^2
...
;      for j = 0, ip-1 do begin 
    for i = 0, 0 do begin ;loop for slit scan
      for j = 0,0 do begin  
        ...
        for k = 0, 0 do begin
          Intensity(j,points(i)) = 1.0 - jdat(j,wave(k),points(i))/cont
          print, "Intensity:", Intensity(0,0)

          LMS = ret_pressure(TA, TB, SZA, EA, PA, dust_opacity, ice_opacity, Albedo_input,wave(k),Intensity(j,points(i)))
          print, "LMS:", LMS
        endfor
