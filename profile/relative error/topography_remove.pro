...
; 2軌道のファイル
; 等価幅法  
restore, '/Users/nyonn/IDLWorkspace/Default/savfile/work_CO2_ORB0920_3_b2.sav'
;restore, '/Users/nyonn/IDLWorkspace/Default/savfile/work_CO2_ORB0920_3_b3.sav'
;restore, '/Users/nyonn/IDLWorkspace/Default/savfile/SPmap_ORB0920_3_B4.sav'
;restore, '/Users/nyonn/IDLWorkspace/Default/savfile/SPmap_ORB0920_3_B2_update.sav'
;restore, '/Users/nyonn/IDLWorkspace/Default/savfile/pressuremap_ORB0920_3_before_notA.sav'
lat1 = lati
lon1 = longi
p1 = pressure
p1 = exp(p1)

restore, '/Users/nyonn/IDLWorkspace/Default/savfile/work_CO2_ORB0931_3_b2.sav'
;restore, '/Users/nyonn/IDLWorkspace/Default/savfile/work_CO2_ORB0931_3_b3.sav'
;restore, '/Users/nyonn/IDLWorkspace/Default/savfile/SPmap_ORB0931_3_B4.sav'
;restore, '/Users/nyonn/IDLWorkspace/Default/savfile/pressuremap_ORB0931_1_before_notA.sav'
...
cgLOADCT, 16
;cgColorbar, Divisions=4, Minor=5, Range=[622,834],position=[0.058,0.57,0.065,0.87],title='Albedo', TCHARSIZE=15,/vertical 
cgColorbar, Divisions=4, Minor=5, Range=[1000,1600],position=[0.058,0.57,0.065,0.87],title='Albedo', TCHARSIZE=15,/vertical 
loadct, 16
;for i = 0, 127 do for j = 0, 595 do if p1(i,j) gt 0 and lat1(i,j) gt 50 and ulat1(i,j) lt 61 and lon1(i,j) gt 272 and lon1(i,j) lt 276.8 then plots, lon1(i,j), lat1(i,j), color=(p1(i,j)-880.)/350.*254., psym=8, symsize=1
...
loadct, 16
;for i = 0, 127 do for j = 0, 595 do if p2_mod(i,j) gt 0 and lat1(i,j) gt 50 and lat1(i,j) lt 61 and lon1(i,j) gt 272 and lon1(i,j) lt 276.8 then plots, lon1(i,j), lat1(i,j), color=(p2_mod(i,j)-880.)/350.*254., psym=8, symsize=1
...
for i = 0, 127 do for j = 0, 595 do if p2_mod(i,j) gt 0 and lat1(i,j) gt 54 and lat1(i,j) lt 56 and lon1(i,j) gt 274 and lon1(i,j) lt 277 then plots, lon1(i,j), lat1(i,j), color=(p2_mod(i,j)-0.1)/0.2*254., psym=8, symsize=1
  ...
  loadct, 33
  ; map
  ;for i = 0, 127 do for j = 0, 595 do if p2_mod(i,j) gt 0 and lat1(i,j) gt 50 and lat1(i,j) lt 61 and lon1(i,j) gt 272 and lon1(i,j) lt 276.8 then plots, lon1(i,j), lat1(i,j), color=(p1(i,j)-p2_mod(i,j)+50)/100.*254., psym=8, symsize=1
