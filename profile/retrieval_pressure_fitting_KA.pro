...
;rad1=dblarr(29)
;
;file100 = '/work1/LUT/SP/table/output_SP11/SP11_TA3_TB2_SZA2_EA1_PA1_Dust1_WaterI1_SurfaceA3_rad.dat'
;openr,lun,file100,/get_lun
...
;
;rad1 = reverse(rad1)
;rad1 = (rad1/wav^2)*1e-7 
;
;window, 1,xs=800,ys=800
;plot, x, y, back=255, color=0, thick=3, psym=-1, xs=1
;
;window, 2,xs=800,ys=800
;plot, wn, rad1, back=255, color=0, thick=3, psym=-1, xs=1
;stop
...
Pro retrieval_pressure_fitting_KA
...
;  if j eq 28 then restore,'/work1/LUT/SP/table/LUT_fitting/Table_calc_wave_new_rad28.sav'
;
;  Table_Equivalent_width = Table_Equivalent_Pressure10
;  y(j) = Table_Equivalent_width(3,2,2,1,1,1,1,3)
;
;endfor
;
;wn=dblarr(29)
...
; save, specmars, filename='/work1/LUT/Common/specmars_CO2_update.sav'
