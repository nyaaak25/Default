...
;restore
restore,'/work1/LUT/SP/table/absorption/density/Table_SP_calc_ver4_add_albedo.sav'
...
for Loop = 0, 1 do begin
  if loop eq 0 then file = path+'ORB0351_3.sav'
...
;      window,loop,xs=1000,ys=800
      ...
      if loop eq 0 then save,filename='/work1/LUT/SP/table/absorption/work_CO2_ORB0351_3.sav',/all
